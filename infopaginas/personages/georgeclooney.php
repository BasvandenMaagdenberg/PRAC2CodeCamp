...
<?php require_once 'head.php'; ?>
    <body>
        ...
        <main>
            <div class="InfoPaginaGeorgeClooney">
                <div class="container"> 
                    <div class="InfoPage">
                        <h1>George Clooney</h1>
                        <div class="InfoImg">
                            <img src="../../img/GeorgeClooney.jpg" alt="Img George Clooney">
                        </div>
                        <div class="InfoText">
                            <p><b>George Clooney, born May 6, 1961 in Lexington, Kentucky, USA, is an actor. He starred as Dr. Doug Ross from the first season to the fifth season. He reprised the role as a guest star in the sixth season episode "Such Sweet Sorrow". He returned as a star for the fifteenth and final season episode "Old Times". He is known for his role as Danny Ocean in the Ocean's Eleven film trilogy. He is also famous for his roles in the films Out of Sight (1998), Three Kings (1999), O Brother, Where Art Thou? (2000), Intolerable Cruelty (2003), Syriana (2005), Good Night, and Good Luck. (2005), Michael Clayton (2007), Up in the Air (2009), and The Descendants (2011).</b></p>

                            <h2>George Clooney</h2>
                            <p>1982	And They Are Off		
